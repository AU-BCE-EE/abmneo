...
plot(CH4_emis_rate ~ time, data = abm_out, type = 'l')
matplot(abm_out$time, abm_out[, nn <- c('m0','m1','m2', 'm3', 'm4', 'm5', 'sr1')], col = cc <- c('blue', 'orange', 'green', 'black', 'black', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
matplot(abm_out$time, abm_out[, nn <- paste0(c('m0','m1','m2', 'm3', 'm4', 'm5', 'sr1'), '_conc')], col = cc <- c('blue', 'orange', 'green', 'black', 'black', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
matplot(abm_out$time, abm_out[, nn <- c('starch', 'Cfat', 'CPs', 'CPf', 'RFd')], col = cc <- c('blue', 'orange', 'green', 'black', 'red'), lty = 1:length(nn), type = 'l')
matplot(abm_out$time, abm_out[, nn <- paste0(c('starch', 'Cfat', 'CPs', 'CPf', 'RFd'), '_conc')], col = cc <- c('blue', 'orange', 'green', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
plot(VFA ~ time, data = abm_out, type = 'l')
plot(starch_conc ~ time, data = abm_out, type = 'l')
