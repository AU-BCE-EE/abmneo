...
sub_pars <- list(
  ...
  xd = 'xd',
  arrA = c(starch = 3.61e12, Cfat = 3.61e12, CPs = 2.065 * 3.61e12, CPf = 2.065 * 3.61e12, RFd = 3.61e12, xd = 3.61e12),
...
plot(CH4_emis_rate ~ time, data = neo_out, type = 'l')
plot(CH4 ~ time, data = neo_out, type = 'l')
matplot(neo_out$time, neo_out[, nn <- c('m0','m1','m2', 'm3', 'm4', 'm5', 'sr1')], col = cc <- c('blue', 'orange', 'green', 'black', 'black', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
matplot(neo_out$time, neo_out[, nn <- paste0(c('m0','m1','m2', 'm3', 'm4', 'm5', 'sr1'), '_conc')], col = cc <- c('blue', 'orange', 'green', 'black', 'black', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
matplot(neo_out$time, neo_out[, nn <- paste0(c('starch', 'Cfat', 'CPs', 'CPf', 'RFd', 'xd'), '_conc')], col = cc <- c('blue', 'orange', 'green', 'black', 'red'), lty = 1:length(nn), type = 'l')
legend('topright', legend = nn, col = cc, lty = 1:length(nn))
plot(VFA ~ time, data = neo_out, type = 'l')
plot(starch_conc ~ time, data = neo_out, type = 'l')
plot(xd_conc ~ time, data = neo_out, type = 'l')
plot(VFA_conc ~ time, data = neo_out, type = 'l')
plot(SO4_conc ~ time, data = neo_out, type = 'l')
plot(COD_load ~ time, data = neo_out, type = 'l')
```
