...
sub_pars2 <- list(
  ...
  sub_fresh = c(slow = 30, mid = 30, fast = 30),
  sub_init = c(slow = 30, mid = 30, fast = 30)
)
```
...
Sulfate reduction is not hard-coded but can easily be specified with the new approach.
...
grp_pars2 <- list(
  ...
  T_min = c(m0 = 0, m1 = 6.41, m2 = 6.41, sr1 = 10),
...
man_pars2 <- list(VFA_fresh = c(CH3COOH = 2), 
		  ...
		  comps = c('SO4m2'),
                  comp_fresh = c(SO4m2 = 10), 
                  comp_init = c(SO4m2 = 10), 
                  pH = 7, 
		  dens = 1000)
```
...
plot(CH4_emis_rate ~ time, data = out6, type = 'l')
plot(CH4 ~ time, data = out6, type = 'l')
plot(SO4m2_conc ~ time, data = out6, type = 'l')
plot(sr1 ~ time, data = out6, type = 'l')
plot(m1 ~ time, data = out6, type = 'l')
plot(CH3COOH_conc ~ time, data = out6, type = 'l')
```
