...
```{r}
plot(temp_C ~ time, data = out_simp_ser, type = 'l')
```
...
```{r}
out_simp_ser[out_simp_ser$time > 280 & out_simp_ser$time < 300, ]
library(data.table)
setDT(out_simp_ser)
out_simp_ser[326:335, .(temp_C, m1, m2, m3, m4, m5, PS, VFA, VFA_conc, CH4_emis_rate)]
