...
Any conservative solute can be added in `inf_pars`, using any names.
...
Now substrates can produce any amount of arbitrary components (defined in `inf_pars`, possibly volatilized, possibly involved in speciation in inhibition) through hydrolysis and fermentation to VFA.
